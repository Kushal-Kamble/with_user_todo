// 🟢 Preload voice on first user interaction (Chrome fix)
...
// 🎛️ Start and stop wave animation
function startWaveAnimation() {
  waveContainer.classList.add("animate");
}
function stopWaveAnimation() {
  waveContainer.classList.remove("animate");
}
...
voiceBtn.addEventListener("click", () => {
  ...
  recognition.onstart = () => startWaveAnimation();
  recognition.onend = () => stopWaveAnimation();
